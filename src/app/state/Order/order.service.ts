...
export class OrderService {
  ...
  confirmedOrder(orderId: String) {
    return this.http
      .put(
        `${this.API_BASE_URL}/api/admin/orders/${orderId}/confirmed`,
        {},
        {
  ...
  shipOrder(orderId: String) {
    return this.http
      .put(
        `${BASE_API_URL}/api/admin/orders/${orderId}/ship`,
        {},
        {
          headers: this.headers,
        }
  ...
  deleteOrder(orderId: String) {
    return this.http
      .delete(`${this.API_BASE_URL}/api/admin/orders/${orderId}/delete`, {
        headers: this.headers,
      })
      .pipe(
        map((data) => {
